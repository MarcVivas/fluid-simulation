...
impl CommandBuffer {
    ...
    pub fn reset(
        ...
        unsafe { device.reset_command_buffer(self.cmd_buffer, reset_flags) }
    }
    ...
    pub fn begin_command_buffer(
        ...
        unsafe { device.begin_command_buffer(self.cmd_buffer, cmd_begin_info) }
    }

    pub fn end_command_buffer(&self, device: &ash::Device) -> VkResult<()> {
        unsafe { device.end_command_buffer(self.cmd_buffer) }
    }
    ...
    pub fn pipeline_global_barrier2(
        &self,
        device: &ash::Device,
    ...
    pub fn bind_pipeline(
        &self,
        device: &ash::Device,
        bind_info: vk::PipelineBindPoint,
    ...
    pub fn dispatch(&self, device: &ash::Device, group_count: [u32; 3]) {
        unsafe {
            device.cmd_dispatch(
                self.cmd_buffer,
                group_count[0],
    ...
    pub fn indirect_dispatch(&self, device: &ash::Device, buffer: vk::Buffer, offset: u64) {
        unsafe {
