...
use crate::{simulation::{neighbor_list::{neighbor_list_data::*, neighbor_search::NeighborSearch}, octree::octree::Octree}, vulkan::{buffers::VkBuffer, commands::CommandBuffer, core::VulkanContext, shaders::traits::GpuTask}, world::particles::ParticleData};
...
impl NeighborList {
    pub fn new(vk_core: &Arc<VulkanContext>, cmd_pool: vk::CommandPool, num_particles: usize, max_expected_leaves: u32, n_crit: u32, max_levels: u32) -> anyhow::Result<Self> {
